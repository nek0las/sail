...
/-- Type quantifiers: k_ex1006_ : Bool, k_ex1005_ : Bool -/
...
/-- Type quantifiers: j : Int, i : Int, n : Nat, n ∈ {16, 32} -/
def foo (i : Int) (j : Int) (n : Nat) (v : (BitVec n)) : Int :=
  ((i +i j) +i (BitVec.toNatInt v))

/-- Type quantifiers: j : Int, i : Int, tuple_2.1 : Nat, tuple_2.1 ∈ {16, 32} -/
def bar (i : Int) (j : Int) (tuple_2 : (Nat × (BitVec k_n))) : Int :=
  let (n, v) := tuple_2
  ((i +i j) +i (BitVec.toNatInt v))
